...
import { createServer } from "./sequentialThinking.js";

console.error('Starting Sequential Thinking MCP Server on SSE...');
...
app.get("/sse", async (req, res) => {
  ...
  if (req?.query?.sessionId) {
    ...
    console.error("Sequential Thinking MCP Server running on SSE. Client Connected: ", transport.sessionId);
